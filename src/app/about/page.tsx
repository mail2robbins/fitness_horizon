  ...
  return (
    <div className="bg-white">
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div className="bg-indigo-50 rounded-lg p-6 shadow-sm">
              ...
              <h3 className="text-lg font-medium text-gray-900">Workout Tracking</h3>
            ...
            <div className="bg-indigo-50 rounded-lg p-6 shadow-sm">
              ...
              <h3 className="text-lg font-medium text-gray-900">Nutrition Tracking</h3>
              <p className="mt-2 text-base text-gray-500">
        ...
        <div className="mt-16">
          <h2 className="text-3xl font-extrabold text-gray-900 text-center">Our Mission</h2>
        ...
        <div className="mt-16">
          <h2 className="text-3xl font-extrabold text-gray-900 text-center">Get Started Today</h2>
